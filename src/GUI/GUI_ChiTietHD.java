 ...
 * @author TriHieu
 */
public class GUI_ChiTietHD extends javax.swing.JFrame {

    /** Creates new form GUI_SelectSP */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_ChiTietHD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_ChiTietHD().setVisible(true);
            }
        });
    }
